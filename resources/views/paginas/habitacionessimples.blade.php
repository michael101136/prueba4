            ...
            <section>
                ...
                <div class="three-fourths">
                	<div class="entry-slider">
                        <ul>
                            <li><a class="fancybox" rel="gallery-living-brown" href="images/entries/full-size/living-brown.jpg" title="Image Title"><span class="overlay zoom"></span><img src="images/entries/700x500/simple1.jpg" alt=""></a></li>
                ...
                <div class="one-fourth column-last">
                    ...
                    <div class="panel panel-info class">
                        <div class="panel-heading"><strong>HABITACIONES SIMPLES</strong></div>
                        <div class="panel-body">
                        <div align="justify"><p>El hotel Abancay, ofrece varios tipos de habitaciones y una de ellas son las habitaciones simples para que nuestros clientes se sientan como en su casa.</p></div>
                        <br>
                        <h3>Servicios</h3><br>
                        <ul class="check">
                            <li>Internet - Wifi</li>
