<script type="text/javascript" src="{{ asset('js/back/plugins/jquery/jquery.min.js')}}"></script>
        ...
        <script type="text/javascript" src="{{ asset('js/back/plugins/tableexport/tableExport.js')}}"></script>
	<script type="text/javascript" src="{{ asset('js/back/plugins/tableexport/jquery.base64.js')}}"></script>
	<script type="text/javascript" src="{{ asset('js/back/plugins/tableexport/html2canvas.js')}}"></script>
	<script type="text/javascript" src="{{ asset('js/back/plugins/tableexport/jspdf/libs/sprintf.js')}}"></script>
	<script type="text/javascript" src="{{ asset('js/back/plugins/tableexport/jspdf/jspdf.js')}}"></script>
	<script type="text/javascript" src="{{ asset('js/back/plugins/tableexport/jspdf/libs/base64.js')}}"></script>        
